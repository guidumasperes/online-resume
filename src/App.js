      ...
      <div className="content-wrap item-details divider">
        ...
        <section className="job-skill-item">
          ...
          <div className="job-skill-summary">
            <p>Desenvolveu uma parte do software de controle interno da plataforma de investimentos da empresa em C# utilizando o Windows Forms e SQL. 
               Desenvolveu uma versão menor da plataforma de investimentos da empresa usando o Microsoft PowerApps. 
               Automatizou planilhas do Excel usando a biblioteca openpyxl do Python agilizando as tarefas dos outros funcionários. Prestou suporte ao usuário na utilização do ERP(brERP) da empresa garantindo maior fluidez nos trabalhos.
               Auxiliou na manutenção da infraestrutura assegurando a continuidade dos serviços.
            </p>
          </div>
        </section>
      </div>
